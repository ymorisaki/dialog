      ...
      value: function createElement() {
        ...
        var createCloseButton = function createCloseButton() {
          return new Promise(function (resolve) {
            _this.closeButton.textContent = 'ダイアログを閉じる';
